  ...
  return React.createElement("div", { style:S.container },
    ...
    React.createElement("div", { style:S.header },
      React.createElement("div", { style:S.toolbar },
        // Filter knoppen
        ...[
          { id:"all",       label:`Alle (${counts.all})`,         color:"#8ac6f2" },
          { id:"bezig",     label:`Bezig (${counts.bezig})`,      color:"#8ac6f2" },
          { id:"nog-lezen", label:`Nog lezen (${counts["nog-lezen"]})`, color:"#eae788" },
          { id:"uit",       label:`Uit (${counts.uit})`,          color:"#9fca56" },
        ...
        React.createElement("div",{style:{marginLeft:"auto",display:"flex",gap:"5px"}},
          ...
          React.createElement("button",{
            ...
            style:{...S.filterBtn(false),padding:"4px 8px",fontSize:"12px"}
          }, viewMode==="grid" ? "☰" : "⊞"),
          // Nieuw boek
          React.createElement("button",{
